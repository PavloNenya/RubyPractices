...
class RegistrationsController < Devise::RegistrationsController
  ...
  def configure_sign_up_params
    devise_parameter_sanitizer.permit(:sign_up, keys:[profile_attributes: [:name, :surname, :fatherly, :date_of_birth, :telephone, :gender, :currency, :avatar]])
  end

  def build_resource(hash = {})
    hash[:profile_attributes] = {} unless hash.key?(:profile_attributes)
    super
  end
