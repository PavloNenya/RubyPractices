...
class PostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poster" do
    assert_difference("Poster.count") do
      post posters_url, params: { poster: { description: @poster.description, price: @poster.price, service_id: @poster.service_id } }
    end
  ...
  test "should update poster" do
    patch poster_url(@poster), params: { poster: { description: @poster.description, price: @poster.price, service_id: @poster.service_id } }
